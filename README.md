...
| `TransformersMLLM` | Multimodal vision-language model (MLLM) from [🤗 Transformers](https://github.com/huggingface/transformers), with image and video inputs  | [`Qwen/Qwen2.5-VL-3B-Instruct`](https://huggingface.co/models?pipeline_tag=image-text-to-text)                                                            | `name`, `checkpoint`, `quantization`, `source`, `init_timeout`                                                  |
| `RoboBrain2`       | Embodied planning + multimodal reasoning via [RoboBrain 2.0 / 2.5](https://github.com/FlagOpen/RoboBrain2.5)                              | [`BAAI/RoboBrain2.0-3B`](https://huggingface.co/collections/BAAI/robobrain20-6841eeb1df55c207a4ea0036)                                                    | `name`, `checkpoint`, `source`, `init_timeout`                                                                  |

...
| `RoboBrain2`       | Embodied planning + multimodal reasoning via [RoboBrain 2.0 / 2.5](https://github.com/FlagOpen/RoboBrain2.5)                              | [`BAAI/RoboBrain2.5-4B`](https://huggingface.co/BAAI/RoboBrain2.5-4B)                                                                                     | `name`, `checkpoint`, `source`, `init_timeout`                                                                  |
